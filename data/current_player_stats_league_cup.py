...
mad_appearances = str(4)  # appearances
mad_goals = str(3)  # goals
mad_assists = str(0)  #
...
alb_appearances = str(4)  # appearances
...
cho_appearances = str(5)  # appearances
...
ndi_appearances = str(3)  # appearances
...
pra_appearances = str(5)  # appearances
